    ...
    <div class="p-6 space-y-6">
        ...
        <div class="card bg-base-100 border shadow-sm">
            <div class="card-body p-6">
                ...
                <form action="{{ route('admin.partner.pelanggan.store') }}" method="POST">
                    @csrf
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="flex justify-center gap-3">
                            ...
                            <form action="{{ route('admin.partner.pelanggan.destroy', $item->id) }}" method="POST">
                                @csrf 
                                @method('DELETE')
                    ...
                    <dialog id="edit-pelanggan-{{ $item->id }}" class="modal">
                        <div class="modal-box border-t-4 border-warning">
                            ...
                            <form action="{{ route('admin.partner.pelanggan.update', $item->id) }}" method="POST" class="space-y-4 mt-4">
                                @csrf 
                                @method('PUT')
